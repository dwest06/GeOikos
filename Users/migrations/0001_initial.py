    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AC', 'Activo'), ('AS', 'Aspirante Estrella'), ('IN', 'Inactivo'), ('EX', 'Ex-miembro')], default='IN', max_length=2, null=True)),
                ('foto', models.ImageField(blank=True, default=None, null=True, upload_to='users/')),
